...
# Configurar Hugging Face FLAN-T5-LARGE
    ...
    try:
        ...
        if isinstance(output, list) and output:
            ...
            if respuesta:
                ...
                return "(El modelo respondió vacío. Puede estar tardando en activarse. Intentá de nuevo.)"
        ...
        return f"(Fallo interno procesando la respuesta: {str(e)})"
...
def responder(texto):
    ...
    return generar_respuesta(f"Pregunta: {texto}. Responde como un niño venezolano de 8 años:")

# Interfaz
st.title("R4F4EL - X (FLAN-T5-Large Estable)")
